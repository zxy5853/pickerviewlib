...
public class TimePickerBuilder {
    ...
    public TimePickerBuilder setMarginHorizontal(int margin) {
        mPickerOptions.marginHorizontal = margin;
        return this;
    }

    public TimePickerBuilder setMinutesInterval(int minutesInterval){
        mPickerOptions.minutesInterval = minutesInterval;
        return this;
    }
