...
import com.bigkoo.pickerview.adapter.IntervalNumericWheelAdapter;
...
public class WheelTime {
    ...
    private int minutesInterval;    //分钟选择间隔
    ...
    public WheelTime(View view, boolean[] type, int gravity, int textSize, int minutesInterval) {
        super();
        this.view = view;
        this.type = type;
        this.gravity = gravity;
    ...
    private void setSolar(int year, final int month, int day, int h, int m, int s) {
        ...
        if (minutesInterval > 1) {
            wv_minutes.setAdapter(new IntervalNumericWheelAdapter(0, 59, 5));
            wv_minutes.setCurrentItem(m / 5);
        } else {
            wv_minutes.setAdapter(new NumericWheelAdapter(0, 59));
            wv_minutes.setCurrentItem(m);
        }
...
//                maxItem = endD;
    ...
    public String getTime() {
        ...
        if (minutesInterval > 1) {
            //设置了分钟间隔
            minutes = wv_minutes.getCurrentItem() * minutesInterval;
        } else {
            minutes = wv_minutes.getCurrentItem();
        }
           ...
           /* int i = wv_month.getCurrentItem() + startMonth;
            ...
            if ((wv_month.getCurrentItem() + startMonth) == startMonth) {
                sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                        ...
                        .append(minutes/*wv_minutes.getCurrentItem()*/).append(":")
