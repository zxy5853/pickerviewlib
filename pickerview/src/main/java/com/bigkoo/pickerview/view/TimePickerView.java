...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initWheelTime(LinearLayout timePickerView) {
        if (mPickerOptions.minutesInterval > 1) {
            wheelTime = new WheelTime(timePickerView, mPickerOptions.type, mPickerOptions.textGravity, mPickerOptions.textSizeContent, mPickerOptions.minutesInterval);
        } else {
